...
# my data
input_file = "./curated_watermelon_molecules.tsv"
out_file = "./curated_watermelon_molecules.json"
properties = {"activities": DEFAULT_ACTIVITY_TYPES, "properties": DEFAULT_PROPERTY_TYPES, "ext_links": []}
treebuild.TreeBuild(input_file, out_file, id_column="afc_id", fps=DEFAULT_FINGERPRINT_TYPES, properties=properties)
...
for fname in ["./curated_watermelon_molecules.json", "./factorxa.json", "./cdk2.json", "./map_p38.json", "./cyto.json"]:
    try:
