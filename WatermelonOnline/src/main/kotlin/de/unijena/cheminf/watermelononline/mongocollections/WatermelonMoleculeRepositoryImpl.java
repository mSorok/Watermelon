...
import de.unijena.cheminf.watermelononline.utils.CustomAggregationOperation;
...
public class WatermelonMoleculeRepositoryImpl implements WatermelonMoleculeRepositoryCustom{

    private final MongoTemplate mongoTemplate;

    @Autowired
    public WatermelonMoleculeRepositoryImpl(MongoTemplate mongoTemplate) {
    ...
    @Override
    public List<WatermelonMolecule> similaritySearch(ArrayList<Integer> reqbits, ArrayList<Integer> qfp, Integer qmin, Integer qmax, Integer qn, Double threshold, Integer maxResults ){
        ...
        AggregationResults results = mongoTemplate.aggregate(agg, "watermelonMolecule", WatermelonMolecule.class);


        List<WatermelonMolecule> returnedNP = results.getMappedResults();

        return returnedNP;
    }

    @Override
    public List<WatermelonMolecule> minMaxMolecularWeightSearch(Double minMolecularWeight, Double maxMolecularWeight, Integer maxResults) {

        List<WatermelonMolecule> result ;
        ...
        result = mongoTemplate.find(advancedQuery , WatermelonMolecule.class);
    ...
    @Override
    public List<WatermelonMolecule> minMolecularWeightSearch(Double minMolecularWeight, Integer maxResults) {
    ...
    @Override
    public List<WatermelonMolecule> maxMolecularWeightSearch(Double maxMolecularWeight, Integer maxResults) {
    ...
    @Override
    public List<WatermelonMolecule> advancedSearchWithCriteria(AdvancedSearchModel criterias, Integer maxResults){
